 ...
 /*
  * tdengine_is_slvar: Check whether the node is schemaless type variable
  */
 bool
 ...
 /*
  * tdengine_is_slvar_fetch: Check whether the node is fetch of schemaless type variable
  */
 bool
 ...
 /*
  * tdengine_is_param_fetch: Check whether the node is fetch of schemaless type param
  */
 bool
 ...
 /*
  * tdengine_get_slvar: Extract remote column name
  */
 char *
 ...
 /*
  * tdengine_get_schemaless_info: Get information required for schemaless processing
  */
 void tdengine_get_schemaless_info(schemaless_info *pslinfo, bool schemaless, Oid reloid)
 {
     ...
     if (schemaless)
     {
         /* cache tdengine_tags and tdengine_fields oids */
 ...
 /*
  * tdengine_slvars_walker: Recursive function for extracting remote columns name
  */
 static bool
 ...
 /*
  * tdengine_pull_slvars: Pull remote columns name
  */
 List *
 ...
 /*
  * tdengine_is_att_dropped: Check if an attribute is dropped or not
  *
 ...
 /*
  * tdengine_validate_foreign_table_sc: Validate format of the foreign table in schemaless mode
  *
     ...
     while (true)
     {
         ...
         else if (strcmp(attname, "tags") == 0 || strcmp(attname, "fields") == 0) /* tags/fields column */
         {
             ...
             if (options != NIL)
             {
                 ...
                 /* Validate option value only because tdengine_fdw_validator() already validated column option */
